...
async def admin_risghts(_, CallbackQuery):
    ...
    if command == "pausecb":
        ...
        await CallbackQuery.message.reply_text(
            f"**» sᴛʀᴇᴀᴍ ᴩᴀᴜsᴇᴅ ʙʏ {CallbackQuery.from_user.mention} !**🥀",
    ...
    if command == "resumecb":
        ...
        await CallbackQuery.message.reply_text(
            f"**» sᴛʀᴇᴀᴍ ʀᴇsᴜᴍᴇᴅ ʙʏ {CallbackQuery.from_user.mention} !**🥀",
            reply_markup=audio_markup,
        )
    ...
    if command == "stopcb":
        ...
        await CallbackQuery.message.reply_text(
            f"**» sᴛʀᴇᴀᴍ ᴇɴᴅᴇᴅ ʙʏ {CallbackQuery.from_user.mention} !**🥀",
