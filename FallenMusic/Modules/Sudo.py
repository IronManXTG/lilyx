...
from FallenMusic import BOT_NAME, OWNER_ID, SUDO_USERS, app
from FallenMusic.Helpers.Database import (get_active_chats, get_served_chats, remove_active_chat)
...
async def update(_, message):
    ...
    if str(m[0]) != "A":
        ...
        return os.system(f"kill -9 {os.getpid()} && python3 -m FallenMusic")
    else:
